...
#RUN git clone -b main https://github.com/kartikrajofficial/Javes /root/userbot
#RUN mkdir /root/userbot/bin/
#WORKDIR /root/userbot/
#RUN chmod +x /usr/local/bin/*
RUN wget https://raw.githubusercontent.com/kartikrajofficial/Javes/main/kartikrun.py
RUN wget https://raw.githubusercontent.com/kartikrajofficial/Javes/main/requirements.txt
RUN pip3 install -r requirements.txt
#CMD ["python3","-m","userbot"]
CMD ["python3","kartikrun.py"]
